...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-semibold text-gray-900 mb-6">Create New Service</h1>
...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Add a new service to the system</p>
        </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <p>Users will be able to see and request this service immediately after creation.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
